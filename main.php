...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link " href="#services">OUR PROGRAMS</a>
          </li>
      ...
      <div class="carousel-item drk active">
        ...
        <div class="carousel-caption">
          ...
          <button type="button" class="btn bg-info animate__animated animate__backInRight"
            style="animation-delay: 2s;">Donate Now</button>
        </div>
      </div>
      <div class="carousel-item drk">
        ...
        <div class="carousel-caption">
          ...
          <button type="button" class="btn bg-info animate__animated animate__lightSpeedInLeft"
            style="animation-delay: 2s;">Have A Visit</button>
        </div>
      </div>
      <div class="carousel-item drk">
        ...
        <div class="carousel-caption">
          ...
          <p class="animate__animated animate__backInLeft" style="animation-delay: 1s;">Leave all your
            ...
            .<br> </p>
          <button type="button" class="btn bg-info animate__animated animate__backInRight"
            style="animation-delay: 2s;">Be A Helping Hand</button>
        </div>
      </div>
    </div>
  ...
  <h1 class="text-center">Our statistics</h1>
  <div class="no">
            <p class="text-center">375</p>
            <h6 class="text-center mt-3">Donation Received</h6>
          </div>
          <div class="no">
            <p class="text-center">798</p>
            <h6 class="text-center mt-3">Total Donars</h6>
          </div>
          <div class="no">
            <p class="text-center">934</p>
            <h6 class="text-center mt-3">Total Organizations</h6>
          </div> 
